...
public class StudentStackTest {
	...
	private void getImplementations() {
		...
		stack3 = new StackImpl<>(3); // pilha vazia
		stack4 = new StackImpl<>(2); // pilha vazia
		stack5 = new StackImpl<>(1); // pilha vazia
	}
	...
	public void testPushComErro() throws StackOverflowException {
		stack2.push(5); // levanta excecao apenas se o tamanho nao permitir outra insercao
	}
	...
	public void testPopComErro() throws StackUnderflowException {
		assertEquals(Integer.valueOf(3), stack3.pop()); // levanta excecao apenas se stack3 for vazia
	}
