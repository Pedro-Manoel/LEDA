...
public interface FloorCeilBST extends BST<Integer>{
	 ...
	 * O floor de um numero eh o inteiro do array menor e que mais se aproxima do numero.
	 ...
	 * O ceil de um numero eh o inteiro do array maior e que mais se aproxima do numero.
