...
public class StudentSortingTest {
	...
	public void testOrdenaArrayComUmElemento () {
		Integer[] array = {5};
		Integer[] copy1 = {5};
		implementation.sort(array);
		Assert.assertArrayEquals(copy1, array);
	...
	public void testOrdenaArrayComAlgunsValoresNegativos (Integer[] array) {
		Integer[] copy1;
		if(array.length >= 3){
			array[0] = -array[0];
			array[1] = -array[1];
	...
	public void testOrdenaArrayComValoresNegativos (Integer[] array) {
		Integer[] copy1;
		if(array.length >= 3){
	...
	public void testSort14 () {
		testOrdenaArrayComUmElemento();
	}

	@Test
	public void testSort15 () {
		testOrdenaArrayComAlgunsValoresNegativos(vetorTamPar);
	}

	@Test
	public void testSort16 () {
		testOrdenaArrayComValoresNegativos(vetorTamPar);
	}
