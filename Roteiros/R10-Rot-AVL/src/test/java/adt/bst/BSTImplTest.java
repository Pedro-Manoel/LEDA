...
public class BSTImplTest {
    ...
    private BTNode<Integer> NIL = new BTNode<>();
    ...
    public void test () {
        ...
        assertEquals(Integer.valueOf(63), tree.search(63).getData());
        assertEquals(Integer.valueOf(52), tree.search(52).getData());
        assertEquals(Integer.valueOf(90), tree.search(90).getData());
        assertEquals(NIL, tree.search(3));
        assertEquals(NIL, tree.search(999));

        assertEquals(Integer.valueOf(65), tree.sucessor(63).getData());
        assertEquals(Integer.valueOf(60), tree.sucessor(59).getData());
        assertEquals(Integer.valueOf(83), tree.sucessor(69).getData());
        assertEquals(Integer.valueOf(63), tree.sucessor(60).getData());
        assertEquals(Integer.valueOf(90), tree.sucessor(83).getData());
        assertEquals(Integer.valueOf(59), tree.sucessor(52).getData());
        assertNull(tree.sucessor(90));

        assertEquals(Integer.valueOf(60), tree.predecessor(63).getData());
        assertEquals(Integer.valueOf(52), tree.predecessor(59).getData());
        assertEquals(Integer.valueOf(65), tree.predecessor(69).getData());
        assertEquals(Integer.valueOf(59), tree.predecessor(60).getData());
        assertEquals(Integer.valueOf(69), tree.predecessor(83).getData());
        assertEquals(Integer.valueOf(7), tree.predecessor(52).getData());
        assertNull(tree.predecessor(2));
    }
