...
public class QuickSelectTest {
    ...
    private QuickSelect<Integer> algorithm;

    @Before
    public void criaClasse () { this.algorithm = new QuickSelect<>(); }

    public void verificaEstatisticaDeOrdem (Integer[] array, int k, Integer retornoEsperado) {
        assertEquals(retornoEsperado, this.algorithm.quickSelect(array.clone(), k));
    }

    public void verificaEstatisticaDeOrdem (Integer[] array, int k, int retornoEsperado) {
        assertEquals(Integer.valueOf(retornoEsperado), this.algorithm.quickSelect(array.clone(), k));
    }
